            ...
            return (
              <g key={n.id} onClick={() => selectNode(n.id)} style={{ cursor: "pointer" }}>
                ...
                <rect x={n.x} y={n.y} width={n.w} height={n.h} rx={7}
                  fill={isSel ? (n.color + "18") : (n.dark ? "#1a1a2e" : COLORS.bg)}
                  stroke={n.color}
